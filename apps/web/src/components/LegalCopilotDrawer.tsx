  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 left-6 z-50 flex items-center gap-2 bg-gradient-to-r from-blue-700 via-indigo-700 to-purple-800 text-white px-5 py-3 rounded-full shadow-2xl hover:scale-105 transition-all duration-300 border border-white/20 group"
      >
        <Sparkles className="w-5 h-5 text-amber-300 animate-pulse" />
        <span className="font-bold text-sm">المرشد القانوني الذكي</span>
